...
```{r, echo=F}
url <- "http://news.naver.com/main/ranking/popularDay.nhn?rankingType=popular_day&sectionId=101&date=20150526"
htxt <- html(url)
```
...
emotion.dict <- read.csv(paste(user.path,"/emotion_dict.csv", sep=""),
                         header = T, 
                         fileEncoding = "UTF-8",
                         stringsAsFactors = F)
```
